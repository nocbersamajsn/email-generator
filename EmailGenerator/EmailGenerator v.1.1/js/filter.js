...
//     const btnGenerate = document.getElementById('btnGenerate').style.display = "none";
//     const btnLoading = document.getElementById('btnLoading').style.display = "none";
...
//     const btnClearLoading = document.getElementById('btnClearLoading');
...
// Pilihan Logo
function pilihLogo(){
    var logoSign = document.getElementById('logoSign')
    var logo = document.getElementsByName('logo');

    if( logo[0].checked){
        // alert('iya');
        logoSign.style.display = 'flex';
    }else if(logo[1].checked){
        // alert('tidak');
        logoSign.style.display = 'none';
    }else {
        alert('Silahkan pilih logo!')
    }
